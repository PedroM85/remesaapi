...
export const getCliente = async (req, res) => {
  try {
    const Querys =
      'SELECT CLI_Id, CLI_Nombre,CLI_Banco,  concat(BAN_Name, " ",BAN_ACC_Name) AS BAN_Name, CLI_Cuenta,CLI_Titular, \
...
export const postCliente = async (req, res) => {
  try {
    ...
    const Values = [
      ...
      req.body.CLI_Banco,
      req.body.CLI_Cuenta,
      req.body.CLI_Titular,
      req.body.CLI_Cedula,
      new Date(),
      new Date(),
      req.body.CLI_ModifiedBy,
      req.body.CLI_Active,
    ];
...
export const putCliente = async (req, res) => {
  try {
    ...
    const Query =
      "UPDATE CLI_Data SET CLI_Nombre = ? ,CLI_Banco = ?, CLI_Cuenta = ?, CLI_Titular = ?, CLI_Cedula = ?, \
...
export const delCliente = async (req, res) => {
  try {
    ...
    const Query =
      "UPDATE CLI_Data SET CLI_ModifiedDateTime = ?,CLI_ModifiedBy = ?, CLI_Active = ? WHERE CLI_Id = ?";
    const Values = [
      new Date(),
      req.body.CLI_ModifiedBy,
      req.body.CLI_Active,
